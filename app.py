...
# -----------------------------
# Helper: Get high-quality cover from Open Library
# -----------------------------
def get_high_quality_cover(title):
    """Fetch a large-size cover image from Open Library using book title."""
    try:
...
@app.route('/')
def index():
    # For the home page (popular books)
    high_quality_images = []
